...
public class CameraConnectionFragment extends Fragment {
    ...
    protected static Size chooseOptimalSize(final Size[] choices, final int width, final int height) {
        ...
        System.out.println("Desired size: " + desiredSize + ", min size: " + minSize + "x" + minSize);
        System.out.println("Valid preview sizes: [" + TextUtils.join(", ", bigEnough) + "]");
        System.out.println("Rejected preview sizes: [" + TextUtils.join(", ", tooSmall) + "]");

        if (exactSizeFound) {
            System.out.println("Exact size match found.");
            return desiredSize;
        }
        ...
        if (bigEnough.size() > 0) {
            ...
            System.out.println("Chosen size: " + chosenSize.getWidth() + "x" + chosenSize.getHeight());
            return chosenSize;
        } else {
            return choices[0];
        }
